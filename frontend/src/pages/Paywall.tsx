...
export default function Paywall({ onWatch }: { onWatch?: () => void }) {
  ...
  return (
    <div style={{ maxWidth: 'var(--shell-max-width)', margin: '0 auto', padding: 'calc(16px + var(--vk-inset-top, 0px)) 6px 32px' }}>
      <div className="fm-card" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
